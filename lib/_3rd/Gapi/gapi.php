...
class gapi
{
  const http_interface = 'curl'; //'auto': autodetect, 'curl' or 'fopen'
  ...
  const account_data_url = 'https://www.googleapis.com/analytics/v3/management/accounts/~all/webproperties/~all/profiles';
